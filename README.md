...
创始人并没有把开发权交给那些有兴趣继续开发联机模组的人，而是只想把所有的事情都拖垮，而显然用最少的努力就可以把事情拖得很久。有些人声称这是因为被动收入，但没有证据表明这一点。尽管我们有着巨大的兴趣和像家一样强大的社区，但创始人仍然认为联机模组只剩下 1-2 年的时间了，社区如此努力地运作却使 SA:MP 成为今天的样子，不值得继续下去，但我们并不这么认为。
